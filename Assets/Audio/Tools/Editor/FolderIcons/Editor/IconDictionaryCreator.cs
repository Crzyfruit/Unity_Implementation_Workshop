...
namespace FolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = "Audio/Tools/Editor/FolderIcons/Icons";
        ...
        internal static void BuildDictionary()
        {
            ...
            {
                var texture = (Texture)AssetDatabase.LoadAssetAtPath($"Assets/Audio/Tools/Editor/FolderIcons/Icons/{f.Name}", typeof(Texture2D));
            ...
            {
                var folderIconSO = (FolderIconSO)AssetDatabase.LoadAssetAtPath($"Assets/Audio/Tools/Editor/FolderIcons/Icons/{f.Name}", typeof(FolderIconSO));
